    ...
    <div class="max-w-5xl mx-auto">
      ...
      >
        ...
        <section class="w-full">
          ...
          <div
            class="bg-white rounded-[10px] p-[12px] mt-[24px] w-max"
            style="box-shadow: 0px 2px 4px 0px rgba(171, 190, 209, 0.35)"
          >
            <h2
              class="text-sm lg:text-base font-bold py-[6px] text-center text-[#C5900B] bg-[#F6B205]/[5%] rounded-[10px] uppercase"
            >
              HARGA PER {{ product.packaging }}
            </h2>
          ...
          <div class="mt-[32px]">
            ...
            <section v-if="product.packaging == 'Mika'" class="mt-[16px]">
              <h3
